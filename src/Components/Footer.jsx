...
const Footer = () => {
    ...
    return (
    <div className='max-w-6xl pb-2 mx-auto  flex flex-col md:flex-row justify-between items-center  font-globalFont text-gray-400 mb-4  left-0 bottom-0 right-0'>
